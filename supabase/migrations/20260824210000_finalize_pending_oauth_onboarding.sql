-- Finalize a verified OAuth pending authorization without reintroducing plaintext credentials.

create function public.finalize_admin_pending_integration_onboarding(
...
begin
  ...
  into
    pending_provider,
    pending_purpose,
    pending_external_account_id,
    pending_encrypted_access_token,
    pending_encrypted_refresh_token,
    pending_access_token_expires_at,
    pending_key_version
