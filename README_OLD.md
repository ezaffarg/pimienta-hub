> Archivo histórico del starter original `next-shadcn-dashboard-starter`.
> No representa el estado actual de e-ngenieria Hub. Se conserva únicamente
> como referencia de upstream.
