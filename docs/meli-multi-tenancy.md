...
La 2.3 prepara repositorios que no exponen lookup global de Store ni membership por Clerk user sin Organization. Store Scope efectivo sigue diferido: Owner/Manager/Employee/Client no reciben todavía resolución de assignments en los guards.
