...
**Estado actual:** Fase 0 completada; Fase 1 cerrada en `b543597`; Fase 2 está en curso. La 2.0 está cerrada; la 2.1 documenta el DDL objetivo y la 2.1B prepara Supabase CLI `2.114.0` como devDependency exacta. No hay tablas ni migraciones aplicadas. El working tree debe verificarse antes de trabajar.
